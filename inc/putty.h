...
struct backend_tag {
	const char *(*init)(void *frontend_handle, void **backend_handle, Config *cfg, const char *host);
	...
	void (*provide_logctx_disables)(void *handle, void *logctx);
	/*
...
void do_defaults(const char *, Config *);
